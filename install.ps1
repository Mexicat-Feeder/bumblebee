...
if (!$SkipService) {
    ...
    @"
# Auto-generated by install.ps1 — starts the dashboard as a background service
...
objShell.Run "powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -File ""$startScript""", 0, False
"@ | Set-Content $vbsWrapper -Encoding UTF8
